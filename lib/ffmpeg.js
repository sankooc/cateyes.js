...
exports.concat = function(resource,callback){
  _concat2(resource,callback);
}
/*
UNIX 操作系统
*/
function _concat2(resource,callback){
    ...
    cmd += ' && rm -f '+ mFile;
    console.log('merge cmd : [%s]',cmd)
    var obj = exec(cmd,callback);
